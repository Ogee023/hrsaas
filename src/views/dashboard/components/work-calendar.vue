<template>
  ...
  <div>
    ...
    <el-calendar v-model="currentDate">
      <!-- date是当前单元格的日期 data是对象 对象里要有显示的day -->
...
export default {
  ...
  methods: {
    dateChange() {
      // 生成新的日期
      this.currentDate = new Date(`${this.currentYear}-${this.currentMonth}-1`) // 一号开始
    },
    // 判断当前是否是周末
    isWeek(date) {
